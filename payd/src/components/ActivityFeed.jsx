  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between">
        ...
        <Link to="#" className="text-xs font-semibold text-payd-700 hover:text-payd-900">
          View all
        </Link>
      </div>
      ...
      <div className="mt-4 divide-y divide-slate-100">
        ...
        {safeItems.map((a) => (
          <div key={a.id} className="flex items-center gap-3 rounded-lg px-2 py-3 transition-colors hover:bg-slate-50">
